...
def main():
    ...
    app.run_webhook(
        ...
        port=8443,        # Порт для Render
        url_path='8240812498:AAFHYTB-QhNdlT3U0aZUKA_N9qdiaYdz0q0',  # Токен как путь
        webhook_url='https://your-bot-name.onrender.com/8240812498:AAFHYTB-QhNdlT3U0aZUKA_N9qdiaYdz0q0'  # Замените на ваш URL
    )
